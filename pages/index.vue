...
<template>
  <main class="">
    <!-- HERO SECTION -->
    <section
      class="flex items-center justify-between h-[100vh] pr-[50px] pt-[10vh] gap-4 bg-gradient-to-t from-white dark:from-black to-blue-500 dark:to-blue-800"
    >
    ...
    <!-- Tab section -->
    <section>
      <h1 class="text-4xl ml-[50px] font-medium px-4">
        All from a single source of truth
      </h1>

      <UTabs
        :items="tabs"
        class="mt-6 ml-[50px] mr-[50px] px-4"
        :ui="{ list: { width: 'w-fit' } }"
      >
        <template #item="{ item }">
          <div class="flex justify-between items-center gap-6 mt-8">
            ...
            <NuxtImg :src="item.image" class="w-[50%]" />
          </div>
        </template>
      </UTabs>
    </section>
    <section>
      <h1 class="text-4xl font-medium text-center mt-20">Esier than ever</h1>
      <div class="flex items-center justify-between max-w-xl mx-auto mt-4">
        ...
        <div
          class="flex-1 bg-gradient-to-r from-blue-500 dark:from-blue-800 to-green-500 dark:to-gray-800 h-2"
        ></div>
        <div
          class="w-16 h-16 bg-green-500 dark:bg-gray-800 rounded-full flex items-center justify-center"
        >
          <Icon
            name="material-symbols:linked-services"
      ...
      <div class="grid grid-cols-2 mt-20">
        <div class="bg-blue-500 dark:bg-blue-800 p-8">
          ...
          <div v-for="(item, index) in templates" :key="index">
            <div class="flex flex-col mt-4">
              <div class="bg-green-500 dark:bg-gray-800 flex items-center gap-5">
                <div
                  class="flex justify-center items-center bg-blue-500/50 dark:bg-blue-800/50 p-3 h-20"
                >
                  <NuxtImg :src="item.image" width="50" height="50" />
                </div>
          ...
          <div
            class="py-4 mt-12 rounded-r-full flex flex-col space-y-2 bg-gradient-to-l from-green-500 dark:from-gray-800 to-blue-500 dark:to-blue-800"
          >
            <Icon name="bxs:quote-alt-left" class="text-8xl" />
        ...
        <div class="bg-green-500 dark:bg-gray-800 p-8">
          <div class="flex flex-col space-y-6 items-center">
            <div class="text-center">
              <h1 class="text-2xl font-medium">Then customize as you grow</h1>
              <p class="text-xl text-center">
                Jira adapts to the woy you work, not the other way around. Start
